...
<p>Omegle <i class="notranslate">(oh&middot;meg&middot;ull) </i> is a great way to meet new friends, even while practicing social distancing. When you use Omegle, you are paired randomly with another person to talk one-on-one. If you prefer, you can add your interests and you’ll be randomly paired with someone who selected some of the same interests.</p>
...
<p><strong>You must be 18+ or 13+ with parental permission and supervision to use Omegle.</strong> See Omegle’s <a href="/static/terms.html" target="_blank">Terms of Service</a> for more info. Parental control protections that may assist parents are commercially available and you can find more info at <a href="https://www.connectsafely.org/controls/" target="_blank">https://www.connectsafely.org/controls/</a> as well as other sites.</p>
